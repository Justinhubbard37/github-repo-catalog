# 📖 Portfolio Operational Field Manual & System Guide
...
```
┌────────────────────────────────────────────────────────────────────────┐
│                        PORTFOLIO TAXONOMY HUBS                         │
├────────────────────────────────────────────────────────────────────────┤
│ 🎓 1. EDUCATION & LEARNING EXPERIENCES                                 │
│    • 1.1 Interactive Studios (Self-study apps, quiz engines)           │
│    • 1.2 Structured Courses (mcp-course, Outskill mastermind labs)     │
│    • 1.3 Content-to-Curriculum (Atlas video analysis, MacroMaster)     │
│    • 1.4 Reference Guides (Curated cheat-sheets & awesome lists)       │
├────────────────────────────────────────────────────────────────────────┤
│ 🤖 2. AGENT SYSTEMS & PROTOCOLS                                        │
│    • 2.1 Harnesses & Hosts (Desktop hosts, runtime governors)          │
│    • 2.2 Agent Skills (Claude Code skills, tool-calling scripts)       │
│    • 2.3 Model Context Protocol (MCP servers, clients, tools)          │
├────────────────────────────────────────────────────────────────────────┤
│ 🗄️ 3. KNOWLEDGE, RETRIEVAL & MEMORY                                    │
│    • 3.1 Knowledge Graphs (3D graphs, GraphRAG ontologies)             │
│    • 3.2 RAG Pipelines (Vector search, document chunking, Supabase)    │
│    • 3.3 Local Vaults (SQLite, OPFS, data-sovereign persistence)       │
├────────────────────────────────────────────────────────────────────────┤
│ 🧠 4. INFERENCE ENGINES & COMPUTE                                      │
│    • 4.1 Serving & Runtimes (vLLM, llama.cpp, Ollama localhost)       │
│    • 4.2 Token Acceleration (FreeToken high-throughput acceleration)   │
│    • 4.3 Multimodal Models (Qwen3-VL vision-language embeddings)       │
├────────────────────────────────────────────────────────────────────────┤
│ 🏢 5. UNIFIED DEVELOPER ENTITY HUBS                                    │
│    • Google, OpenAI / Anthropic, Meta / Microsoft, Open Frontier Labs  │
└────────────────────────────────────────────────────────────────────────┘
```
